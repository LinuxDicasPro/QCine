...
VlcWidgetVolumeSlider::VlcWidgetVolumeSlider(VlcMediaPlayer *player, QWidget *parent)
    : QSlider(parent), _vlcAudio(player->audio()), _vlcMediaPlayer(player) {
    initWidgetVolumeSlider();
}

VlcWidgetVolumeSlider::VlcWidgetVolumeSlider(QWidget *parent) : QSlider(parent) {
    initWidgetVolumeSlider();
}
