...
VlcModuleDescription::VlcModuleDescription(Type type, const QString &name) : _type(type), _name(name) {}

VlcModuleDescription::~VlcModuleDescription() = default; // LCOV_EXCL_LINE
