...
public:
    static int volumeCallback(vlc_object_t *obj, const char *name, vlc_value_t oldVal,
                              vlc_value_t newVal, void *data) {
        Q_UNUSED(obj)
        Q_UNUSED(name)
        Q_UNUSED(oldVal)

        auto *core = static_cast<VlcAudio *>(data);
    ...
    static int muteCallback(vlc_object_t *obj, const char *name, vlc_value_t oldVal,
                            vlc_value_t newVal, void *data) {
        Q_UNUSED(obj)
        Q_UNUSED(name)
        Q_UNUSED(oldVal)
...
VlcAudio::VlcAudio(VlcMediaPlayer *player) : QObject(player), _vlcMediaPlayer(player->core()) {
