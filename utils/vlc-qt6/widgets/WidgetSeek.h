...
public:
    ...
    */
    explicit VlcWidgetSeek(VlcMediaPlayer *player, QWidget *slider = nullptr,
                           bool connectSlider = true, QWidget *parent = nullptr);
    ...
    /*!
        ...
        \param parent seek widget's parent GUI widget
    */
    explicit VlcWidgetSeek(QWidget *slider, bool connectSlider, QWidget *parent = nullptr);

    /*!
        \brief VlcWidgetSeek constructor
        \param parent seek widget's parent GUI widget
    */
    explicit VlcWidgetSeek(QWidget *parent = nullptr);

    /*!
        \brief VlcWidgetSeek destructor
    */
    ~VlcWidgetSeek() override;

    /*!
        \brief Get auto-hide option.
        \return auto-hide option status, true if enabled
    */
    [[nodiscard]] bool autoHide() const { return _autoHide; }
    ...
    */
    virtual void setSliderWidget(QWidget *slider, bool updateSlider);
