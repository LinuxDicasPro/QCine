...
public:
    ...
    */
    explicit VlcTrackModel(QObject *parent = nullptr);
    ...
    /*!
        ...
        \param parent parent object
    */
    explicit VlcTrackModel(const QMap<int, QString> &tracks, QObject *parent = nullptr);
    ...
    */
    ...
    /*!
        ...
        \param role required role
    */
    [[nodiscard]] QVariant data(int row, int role) const;
    ...
    */
    void insert(int id, const QString &title);
