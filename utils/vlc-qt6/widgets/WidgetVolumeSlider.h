...
public:
    ...
    */
    explicit VlcWidgetVolumeSlider(VlcMediaPlayer *player, QWidget *parent = nullptr);

    /*!
        \brief VlcWidgetVolumeSlider constructor
        \param parent volume slider's parent GUI widget
    */
    explicit VlcWidgetVolumeSlider(QWidget *parent = nullptr);

    /*!
        \brief VlcWidgetVolumeSlider destructor
    */
    ~VlcWidgetVolumeSlider() override;
...
public slots:
    ...
    */
    [[nodiscard]] int volume() const { return _currentVolume; }
