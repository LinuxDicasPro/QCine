...
public:
    ...
    */
    explicit VlcModuleDescription(Type type, const QString &name);
    ...
    */
    ...
    /*!
        ...
        \return module name
    */
    [[nodiscard]] inline QString name() const { return _name; }

    /*!
        \brief Get short module readable name
        \return short module human readable name
    */
    [[nodiscard]] inline QString shortName() const { return _shortName; }
    ...
    */
    [[nodiscard]] inline QString longName() const { return _longName; }
    ...
    */
    ...
    /*!
        ...
        \return module help
    */
    [[nodiscard]] inline QString help() const { return _help; }
