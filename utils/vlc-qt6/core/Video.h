...
public:
    ...
    */
    [[nodiscard]] Vlc::Scale scale() const;
    ...
    */
    [[nodiscard]] int subtitleCount() const;
    ...
    */
    ...
    /*!
        ...
        \since VLC-Qt 1.1
    */
    [[nodiscard]] QMap<int, QString> subtitles() const;
    ...
    */
    [[nodiscard]] bool takeSnapshot(const QString &path) const;

    /*!
        \brief Get current teletext page requested.
        \return current teletext page number (int)
    */
    [[nodiscard]] int teletextPage() const;
    ...
    */
    ...
    /*!
        ...
        \since VLC-Qt 1.1
    */
    [[nodiscard]] QMap<int, QString> tracks() const;
