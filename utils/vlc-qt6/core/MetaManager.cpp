...
VlcMetaManager::VlcMetaManager(VlcMedia *media) : _media(media) {
//    libvlc_media_parse(media->core());
    libvlc_media_parse_with_options(media->core(), libvlc_media_parse_local, -1);
}

VlcMetaManager::~VlcMetaManager() = default;
