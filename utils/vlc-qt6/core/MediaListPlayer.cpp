...
VlcMediaListPlayer::VlcMediaListPlayer(VlcInstance *instance) : QObject(instance), _mode(Vlc::DefaultPlayback) {
...
VlcMediaListPlayer::VlcMediaListPlayer(VlcMediaPlayer *player, VlcInstance *instance)
    : QObject(instance), _mode(Vlc::DefaultPlayback) {
    _player = player;
...
void VlcMediaListPlayer::libvlc_callback(const libvlc_event_t *event, void *data) {
    auto *core = static_cast<VlcMediaListPlayer *>(data);
