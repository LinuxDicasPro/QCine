...
public:
    ...
    */
    explicit VlcInstance(const QStringList &args, QObject *parent = nullptr);

    /*!
        VlcInstance destructor
    */
    ~VlcInstance() override;

    /*!
        \brief Returns libvlc instance object.
        \return libvlc instance (libvlc_instance_t *)
    */
    libvlc_instance_t *core() { return _vlcInstance; }
    ...
    */
    ...
    /*!
        ...
        \since VLC-Qt 1.1
    */
    [[nodiscard]] Vlc::LogLevel logLevel() const { return _logLevel; }
    ...
    /*!
        ...
        \since VLC-Qt 1.1
    */
    void setLogLevel(Vlc::LogLevel level) { _logLevel = level; }
    ...
    */
    [[nodiscard]] QList<VlcModuleDescription *> audioFilterList() const;

    /*!
        \brief List video filter modules
        \return video filter module description list
    */
    [[nodiscard]] QList<VlcModuleDescription *> videoFilterList() const;
