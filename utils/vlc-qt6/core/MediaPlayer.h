...
public:
    ...
    */
    [[nodiscard]] libvlc_media_player_t *core() const { return _vlcMediaPlayer; }

    /*!
        \brief Returns audio manager object.
        \return audio manager (VlcAudio *)
    */
    [[nodiscard]] VlcAudio *audio() const { return _vlcAudio; }

    /*!
        \brief Returns video manager object.
        \return video manager (VlcVideo *)
    */
    [[nodiscard]] VlcVideo *video() const { return _vlcVideo; }
    ...
    */
    [[nodiscard]] VlcEqualizer *equalizer() const { return _vlcEqualizer; }
    [[nodiscard]] AudioDevice *audioDevice() const { return _audioDevice; }
#endif
    ...
    */
    [[nodiscard]] VlcMedia *currentMedia() const { return _media; }
...
public:
    ...
    */
    void setVideoWidget(VlcVideoDelegate *widget) { _videoWidget = widget; }

    /*!
        \brief Get video output status
        \return video output status (const bool)
    */
    [[nodiscard]] bool hasVout() const;
    ...
    */
    [[nodiscard]] Vlc::State state() const;

    /*!
        \brief Get current video widget.
        \return current video widget (VlcVideoWidget *)
    */
    [[nodiscard]] VlcVideoDelegate *videoWidget() const { return _videoWidget; }
