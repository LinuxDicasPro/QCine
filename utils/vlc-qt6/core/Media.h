...
public:
    ...
    */
    explicit VlcMedia(const QString &location, bool localFile, VlcInstance *instance);
    ...
    /*!
        ...
        \param instance main libvlc instance (VlcInstance *)
    */
    explicit VlcMedia(const QString &location, VlcInstance *instance);
    ...
    */
    libvlc_media_t *core() { return _vlcMedia; }
    ...
    */
    ...
    /*!
        ...
        \return QString output file
    */
    QString record(const QString &name, const QString &path, const Vlc::Mux &mux,
                   const Vlc::AudioCodec &audioCodec, const Vlc::VideoCodec &videoCodec,
                   int bitrate, int fps, int scale, bool duplicate = false);
